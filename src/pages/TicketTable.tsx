...
//             <Avatar
//               sx={{
//                 bgcolor: ticket.status_id === 1 ? '#1abc9c' : '#f39c12',
//                 width:40,
//                 height: 40,
//                 fontSize: '1.1rem',
//                 fontWeight: 'bold',
...
//                     <BellIcon sx={{ fontSize: 20, color: '#1abc9c' }} />
//                   )}
//                   <Typography
//                     variant="body2"
//                     sx={{
...
//                     }}
//                   >
//                     סטטוס: <strong>{ticket.status_name}</strong>
//                   </Typography>
...
//                     }}
//                   >
//                     עדיפות: <strong>{ticket.priority_name}</strong>
//                   </Typography>
//                 </Box>
...
//                     </Button>
//                   )}
// <AssignAgent ticketId={ticket.id} ></AssignAgent>
//                   {userRole === 'admin' && (
//                     <IconButton
//                       color="error"
//                       onClick={(e) => {
